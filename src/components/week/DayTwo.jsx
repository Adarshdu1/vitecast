...
export default function DayTwo({ weatherData, isCelcius }) {
  ...
  useEffect(() => {
    ...
    setId(weatherData.list[7].weather[0].id);
    if (isCelcius) {
      const tmp = weatherData.list[7].main.temp_min;
      setMinTemp(tmp.toFixed(0));
      const tmp2 = weatherData.list[7].main.temp_max;
