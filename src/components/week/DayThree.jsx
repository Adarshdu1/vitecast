...
export default function DayThree({ weatherData, isCelcius }) {
  ...
  useEffect(() => {
    ...
    setId(weatherData.list[13].weather[0].id);
    if (isCelcius) {
      const tmp = weatherData.list[13].main.temp_min;
      setMinTemp(tmp.toFixed(0));
      const tmp2 = weatherData.list[13].main.temp_max;
