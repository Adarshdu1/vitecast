...
export default function DaySeven({ weatherData, isCelcius }) {
  ...
  useEffect(() => {
    ...
    setId(weatherData.list[39].weather[0].id);
    if (isCelcius) {
      const tmp = weatherData.list[39].main.temp_min;
      setMinTemp(tmp.toFixed(0));
      const tmp2 = weatherData.list[39].main.temp_max;
